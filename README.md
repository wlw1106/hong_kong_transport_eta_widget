...
> [!Caution]
> 受限於 iOS 系統對桌面小工具背景重新整理頻率的嚴格限制，本小工具所顯示的到站時間不一定是當刻的實時數據。因此，在參考班次時間前，請務必先**核對小工具左下角的「最後更新時間」**，若發現數據未及時更新，可直接點擊右下角的「REFRESH」區域進行**手動強制更新**，以確保獲取最新、最準確的到站資訊。
...
*(註：如果未來有建立類似九巴/城巴的 MTRB 車站搜尋網頁，也可以將連結補充在此處，方便使用者一鍵查詢。)*
...
| 路線 | 路線方向說明 | 路線 | 路線方向說明 | 路線 | 路線方向說明 | 路線 | 路線方向說明 |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **505** | 兆康至三聖 | **615** | 元朗至屯門碼頭 | **506P** | 屯門碼頭至兆康 | **615P** | 兆康至屯門碼頭 |
| **507** | 田景至屯門碼頭 | **705** | 天水圍循環綫 | **610** | 元朗至屯門碼頭 | **706** | 天水圍循環綫 |
| **614** | 元朗至屯門碼頭 | **720** | 兆康至天榮 | **614P** | 兆康至屯門碼頭 | **751** | 友愛至天逸 |
| **761P** | 元朗至天逸 | **751P** | 天水圍至天逸 |

### 輕鐵車站代碼 (stn)
| 代碼 | 車站名稱 | 代碼 | 車站名稱 | 代碼 | 車站名稱 | 代碼 | 車站名稱 |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
...
| **180** | 山景(北) | **190** | 山景(南) | **200** | 鳴琴 | **212** | 大興(北) |
| **220** | 大興(南) | **230** | 銀圍 | **240** | 兆禧 | **250** | 屯門泳池 |
| **260** | 豐景園 | **265** | 兆麟 | **270** | 安定 | **275** | 友愛 |
| **280** | 市中心 | **295** | 屯門 | **300** | 杯渡 | **310** | 何福堂 |
| **320** | 新墟 | **330** | 景峰 | **340** | 鳳地 | **350** | 藍地 |
| **360** | 泥圍 | **370** | 鍾屋村 | **380** | 洪水橋 | **390** | 塘坊村 |
| **400** | 屏山 | **425** | 坑尾村 | **430** | 天水圍 | **435** | 天慈 |
| **445** | 天耀 | **448** | 樂湖 | **450** | 天湖 | **455** | 銀座 |
| **460** | 天瑞 | **468** | 頌富 | **480** | 天富 | **490** | 翠湖 |
| **500** | 天榮 | **510** | 天悅 | **520** | 天秀 | **530** | 濕地公園 |
| **540** | 天恒 | **550** | 天逸 | **560** | 水邊圍 | **570** | 豐年路 |
| **580** | 康樂路 | **590** | 大棠路 | **600** | 元朗 | **920** | 三聖 |

### 訊息描述
<img alt="App Screenshot" src="https://github.com/user-attachments/assets/e411ec69-1be3-43c2-a32f-fda2682f5a3e" height="150">
<table>
  <tr>
    <th>訊息描述</th>
    <th>説明</th>
...
## 資料來源
本專案的實時交通數據均獲取自香港的公開數據平台，感謝以下機構提供開放數據（Open Data）：
* [香港政府資料一線通 (Data.gov.hk)](https://data.gov.hk/)：提供城巴 (CTB)、新大嶼山巴士 (NLB) 等實時數據。
* **九巴開放數據 API (KMB Open API)**：提供九龍巴士 (KMB) 及龍運巴士 (LWB) 實時數據。
* [港鐵開放數據 (MTR Open Data)](https://data.gov.hk/en-datasets/provider/mtr)：提供港鐵 (MTR)、輕鐵 (LRT) 及港鐵巴士 (MTRB) 實時到站時間及車站清單。

## 免責聲明
* **數據準確性**：本小工具顯示的到站時間及車務狀況僅供參考。所有資料均由上述第三方 API 即時提供。若第三方伺服器發生故障、數據延遲或進行系統維護，或 iOS 系統限制導致的資訊延誤，本工具可能無法顯示正確資訊，開發者對此不承擔任何責任。
* **非官方專案**：本專案為個人開發的開源學習項目，與任何香港公共交通營運商（如九巴、城巴、港鐵等）或香港特別行政區政府無任何官方合作或從屬關係。
* **使用風險**：使用者需自行承擔因依賴本工具數據而導致的任何錯過班次、行程延誤或其他損失之風險。建議通勤者出門前預留充足時間，或在有需要時參考官方應用程式。
